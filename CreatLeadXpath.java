...
@Test
	public static void createLeadXpat()
	{
...
driver.findElement(By.xpath("(//input[@class='inputBox'])[20]")).sendKeys("keetu@gmail.com");

driver.findElement(By.xpath("(//input[@class='inputBox'])[17]")).sendKeys("9944899321");
